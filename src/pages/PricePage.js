        ...
        return (
            <>
                ...
                <div className="border-2 mt-4">
                    ...
                    <input type="number" name="weight(kg)" className="border border-slate-300" placeholder="Weight(kg)" onChange={(e) => setWeight(e.target.value)} />
                </div>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-3" onClick={(e) => checkPrice()}>Cek bos</button>
                <div className="border-2 mt-4">
                    {output.regular > 0 ? <h3>Regular: {output.regular} <br /> Extra: {output.extra}</h3> : null}
                </div>
            </>
        )
    }
